package ${package}.test.integration.ruby;
/*
 ...
 */
@TestVerticleInfo(filenameFilter=".+${symbol_escape}${symbol_escape}.rb", funcRegex="def[${symbol_escape}${symbol_escape}s]+(test[^${symbol_escape}${symbol_escape}s]+)")
